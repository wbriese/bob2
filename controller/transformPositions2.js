...
function addProperties(el) {
  ...
  const rpmSpeedRatio = +el.rpm / SPEED_KNOTS;
  return {
    ...el, rpmSpeedRatio: rpmSpeedRatio.toFixed(2), SPEED_KNOTS, COURSE, MEcons, AEcons, dist, draftAft, draftFwd, nextPort, distToGo, seaTemperature, AVGSpeed, fuelNM, USDNM, MEconsAvgSpeed,
  };
}
